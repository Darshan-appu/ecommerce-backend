document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchCustomers(searchTerm = '') {
        try {
            const response = await fetch(`https://ecommerce-backend-qqhv.onrender.com/api/users/by-role?role=CUSTOMER`, {
                headers: {
    ...
    updateCustomerBtn.addEventListener('click', async() => {
        ...
        try {
            const response = await fetch(`https://ecommerce-backend-qqhv.onrender.com/api/users/${id}`, {
                method: 'PUT',
                headers: {
    ...
    saveCustomerBtn.addEventListener('click', async() => {
        ...
        try {
            const response = await fetch('https://ecommerce-backend-qqhv.onrender.com/api/auth/register', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
